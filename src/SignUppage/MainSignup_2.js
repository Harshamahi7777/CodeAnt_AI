            ...
            <div className="row">
                ...
                <div className="col-6" style={{ background:"#fafafa" }}>
                    ...
                    <div className='content mb-2' style={{width:"500px",height:"175px",padding:"18px 24px 36px 20px",borderBottom:"1px solid #d5d7da",boxSizing:"border-box",overflow:"hidden"}}>
                       ...
                       <Link to="/Saas"><button type="button" class="btn btn-light "style={{width:"187.5px",fontWeight:"600"}} >SAAS</button></Link>
                       <Link to="/Self_hosted"><button type="button" class="btn btn-primary btn"style={{width:"185px",borderRadius:"0px",fontWeight:"600"}}>Self Hosted</button></Link>
                    ...
                    <div className='main p-2 ' style={{width:"500px",height:"225px",overflow:"visible",display:"flex",flexDirection:"column"}}>
                        ...
                        <button type='button' className=' btn btn-light '  style={{width:"275px",height:"40px",border:"1px solid #d8dad5",marginLeft:"6em",display:"flex" ,justifyContent:"space-around",marginTop:"1em"}}>
                            <img src='/imports/SSo.png' style={{width:"20px",height:"24px",marginTop:"0.3em",marginLeft:"2.5em"}}></img>
                            <p style={{fontSize:"12px", padding:"0em 1.25em",fontWeight:"600"}}>Sign In With SSO</p>
                        </button>
                            
                        
                    </div>
                    </div>
                    <p style={{fontSize:"16px",fontWeight:"400",marginLeft:"9em"}}>By signing up you agree to the <span style={{fontWeight:"700"}}>privacy policy</span></p>
                </div>
            </div>
        </div>
     );
